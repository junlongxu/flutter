  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: <String, WidgetBuilder>{
        ...
        'http': (BuildContext centext) => Http(),
        'shared': (BuildContext centext) => Shared(),
        'listlayout': (BuildContext centext) => ListLayout()
      }
    );
  }
}
    ...
    return Container(
      child: Column(
        children: <Widget>[
          ...
          _item('http', Http(), 'http'),
          _item('本地缓存', Shared(), 'shared'),
          _item('列表', ListLayout(), 'listlayout'),
        ]
      )
    );
  }
